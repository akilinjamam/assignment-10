        ...
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            {
                ...
                <div onClick={() => handlePageButton('decrease')}> <span style={{ fontSize: '15px', marginRight: '25px', cursor: 'pointer' }}><i className="uil uil-angle-left-b"></i></span> </div>
            }
            {
            ...
            {
                mappedArray?.length > 0 &&
                <div onClick={() => handlePageButton('increase')}> <span style={{ fontSize: '15px', marginLeft: '15px', cursor: 'pointer' }}><i className="uil uil-angle-right-b"></i></span> </div>
            }
        </div>
    );
};
